...
'			Me.customRadioGroup1.Properties.CustomDrawItem += New WindowsApplication3.CustomDrawEventHandler(Me.OnCustomDrawItem);
		...
		Private WithEvents customRadioGroup1 As CustomRadioGroup
	End Class
End Namespace
